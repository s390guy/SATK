...
*
         TITLE 'PGM4 - HELLO WORLD WITH CONSOLE I/O'
* Program Description:
*
* PGM4 is a bare-metal 'Hello World' program.  It requires input/output
* commands to the console device to issue the message.  The program is
* executed by means of FBA DASD boot loader.
*
...
*                PSW at address X'38'
*    X'041004' - Console Device X'00F' or channel not operational
*    X'041008' - Console Device X'00F' or channel busy
*    X'04100C' - Console Device X'00F' or channel had a problem. See CSW.
*    X'041010' - Unexpected interruption from some other device. See ASA X'BA'
*    X'041014' - Console channel error occurred
*    X'041018' - Console device did not complete the I/O without a problem
         EJECT
...
* This results in BOOTED4.bin being created in the list directed IPL directory
...
BUSYDEV  DWAIT PGM=04,CMP=1,CODE=008  Console device busy
CSWSTR   DWAIT PGM=04,CMP=1,CODE=00C  CSW stored in ASA
NOTCON   DWAIT PGM=04,CMP=1,CODE=010  Unexpected interruption from other device
CHERROR  DWAIT PGM=04,CMP=1,CODE=014  Console channel error occurred
DVERROR  DWAIT PGM=04,CMP=1,CODE=018  Console device error occurred
         END