...
* Program Description:
*
* PGM4390 is a bare-metal 'Hello World' program.  It uses boot loader
* services to issue the message.  The program is executed by means of FBA DASD
* boot loader configured for S/370 operation.
*
...
ENDBAD   DWAIT PGM=05,CMP=1,CODE=000  Updated with abend code
         TITLE 'PGM5 - BOOT LOADER SERVICES PARAMETER BLOCKS'
*
