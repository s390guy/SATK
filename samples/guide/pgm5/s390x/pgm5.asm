...
*
         TITLE 'PGM5Z - HELLO WORLD WITH BOOT LOADER SERVICES ON Z'
* Program Description:
*
* PGM5Z is a bare-metal 'Hello World' program.  It uses boot loader
* services to issue the message.  The program is executed by means of FBA DASD
* boot loader also configured for z/Arch operation.
*
* Target Architecture: z/Arch
*
* Devices Used:
...
ENDBAD   DWAIT PGM=05,CMP=1,CODE=000  Updated with abend code
         TITLE 'PGM5Z - BOOT LOADER SERVICES PARAMETER BLOCKS'
*
...
ENASPB   DC    Y(ENADEV)    Service ID for ENADEV service (from BLSTABLE)
         ...
         SPACE 1
* Service Parameter Block Extension
...
MSSGLEN  EQU   *-MESSAGE                    Length of Hello World text data
         SPACE 3
         TITLE 'PGM5Z - DSECTS AND EQUATES'
*
